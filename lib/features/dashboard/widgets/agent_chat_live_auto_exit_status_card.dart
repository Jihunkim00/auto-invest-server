...
class AgentChatLiveAutoExitStatusCard extends StatelessWidget {
  const AgentChatLiveAutoExitStatusCard({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return SectionCard(
      key: const ValueKey('agent-chat-live-auto-exit-status-card'),
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Row(children: [
          ...
          const Expanded(
            child: Text(
              'Agent Chat Live Auto Exit Status',
              style: TextStyle(fontSize: 17, fontWeight: FontWeight.w900),
            ),
          ),
          OutlinedButton.icon(
            key: const ValueKey('agent-chat-live-auto-exit-refresh'),
        ...
        Wrap(spacing: 10, runSpacing: 8, children: [
          ...
          _Metric(
            label: 'Candidates',
            value: '${readiness?.candidateCount ?? 0}',
          ),
          _Metric(
