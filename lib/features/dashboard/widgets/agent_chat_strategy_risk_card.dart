...
class AgentChatStrategyRiskCard extends StatelessWidget {
  const AgentChatStrategyRiskCard({super.key, required this.card});
  ...
  Widget build(BuildContext context) {
    return Container(
      key: ValueKey('agent-chat-strategy-risk-card-${card.cardType}'),
