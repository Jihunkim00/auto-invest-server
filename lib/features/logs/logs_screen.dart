...
import 'widgets/automation_release_status_panel.dart';
...
import 'widgets/portfolio_orchestrator_panel.dart';
...
class _LogsScreenState extends State<LogsScreen> {
  ...
  Future<void> _loadLogs() async {
    ...
    try {
      ...
      await widget.controller.refreshOperatorAlerts(silent: true);
      ...
      await widget.controller.refreshAutomationReleaseStatus(silent: true);
      ...
      await widget.controller.refreshAutoSellLivePhase1(silent: true);
      ...
      child: RefreshIndicator(
        ...
        child: ListView(
          ...
          children: [
            ...
            OperatorAlertsPanel(controller: widget.controller),
            const SizedBox(height: 14),
            ...
            const SizedBox(height: 14),
            AutomationReleaseStatusPanel(controller: widget.controller),
            const SizedBox(height: 14),
            ...
            const SizedBox(height: 14),
            AutoBuyPromotionQueuePanel(controller: widget.controller),
            const SizedBox(height: 14),
