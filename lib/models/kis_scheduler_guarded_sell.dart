class KisSchedulerGuardedSellResult {
  const KisSchedulerGuardedSellResult({
    ...
    required this.schedulerSellOnly,
    required this.buyExecutionAllowed,
    required this.schedulerBuyExecutionBlocked,
  ...
  factory KisSchedulerGuardedSellResult.fromJson(Map<String, dynamic> json) {
    final safety = _dynamicMap(json['safety']);
    final summary = _dynamicMap(json['summary']);
    return KisSchedulerGuardedSellResult(
      ...
      mode: _stringValue(json['mode'], fallback: 'kis_scheduler_guarded_sell'),
      triggerSource: _stringValue(json['trigger_source'],
          fallback: 'scheduler_guarded_sell'),
      requestedTriggerSource: _stringValue(
        json['requested_trigger_source'],
        fallback: 'scheduler_manual_test',
      ),
      slotLabel:
          _stringValue(json['slot_label'], fallback: 'manual_guarded_sell'),
      ...
      sellOnly: _boolValue(json['sell_only'] ?? safety['sell_only']) ?? true,
      schedulerSellOnly: _boolValue(
              json['scheduler_sell_only'] ?? safety['scheduler_sell_only']) ??
          true,
      buyExecutionAllowed: _boolValue(
            json['buy_execution_allowed'] ?? safety['buy_execution_allowed'],
          ) ??
          false,
      schedulerBuyExecutionBlocked: _boolValue(
            json['scheduler_buy_execution_blocked'] ??
                safety['scheduler_buy_execution_blocked'],
          ) ??
          true,
      ...
      trigger: _nullableString(json['trigger'] ?? summary['trigger']),
      summary: summary,
  ...
  final bool sellOnly;
  final bool schedulerSellOnly;
  final bool buyExecutionAllowed;
  final bool schedulerBuyExecutionBlocked;
