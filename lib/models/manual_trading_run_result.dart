...
class ManualTradingRunResult {
  ...
  factory ManualTradingRunResult.fromJson(Map<String, dynamic> json) {
    ...
    final gptContextMap = _asMap(json['gpt_context'] ?? payload['gpt_context']);
    ...
    return ManualTradingRunResult(
      ...
      action: _stringValue(
          ...
          fallback: 'unknown'),
      reason: _stringValue(
          payload['reason'] ?? signal['reason'] ?? json['reason'] ?? run['reason'],
          fallback: ''),
      ...
      signalStatus: _nullableString(
          json['signal_status'] ?? payload['signal_status'] ?? signal['status']),
      buyScore: _doubleValue(
          json['buy_score'] ?? payload['buy_score'] ?? scores['buy_score']),
      sellScore: _doubleValue(
          json['sell_score'] ?? payload['sell_score'] ?? scores['sell_score']),
