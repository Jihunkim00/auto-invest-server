        ...
        conn.execute(
            text(
                ...
                CREATE TABLE IF NOT EXISTS runtime_settings (
                    ...
                    auto_buy_live_phase1_enabled BOOLEAN NOT NULL DEFAULT 0,
                    auto_buy_live_phase1_max_orders_per_day INTEGER NOT NULL DEFAULT 1,
                    auto_buy_live_phase1_max_notional_pct FLOAT NOT NULL DEFAULT 0.03,
                    auto_buy_live_phase1_max_notional_krw FLOAT NOT NULL DEFAULT 50000,
                    auto_buy_live_phase1_require_production_ready BOOLEAN NOT NULL DEFAULT 1,
                    auto_buy_live_phase1_allow_real_orders BOOLEAN NOT NULL DEFAULT 0,
                    auto_buy_live_phase1_provider VARCHAR(20) NOT NULL DEFAULT 'kis',
                    auto_sell_live_phase1_enabled BOOLEAN NOT NULL DEFAULT 0,
                    auto_sell_live_phase1_max_orders_per_day INTEGER NOT NULL DEFAULT 1,
                    auto_sell_live_phase1_allow_real_orders BOOLEAN NOT NULL DEFAULT 0,
                    auto_sell_live_phase1_require_production_ready BOOLEAN NOT NULL DEFAULT 1,
                    auto_sell_live_phase1_provider VARCHAR(20) NOT NULL DEFAULT 'kis',
                    auto_sell_live_phase1_allowed_candidate_types TEXT NOT NULL DEFAULT '["stop_loss", "take_profit", "trend_breakdown", "weak_momentum"]',
                    ...
                    portfolio_orchestrator_max_actions_per_run INTEGER NOT NULL DEFAULT 1,
                    portfolio_orchestrator_require_production_ready BOOLEAN NOT NULL DEFAULT 1,
                    portfolio_orchestrator_skip_buy_if_sell_candidate BOOLEAN NOT NULL DEFAULT 1,
                    portfolio_orchestrator_skip_buy_if_sync_required BOOLEAN NOT NULL DEFAULT 1,
                    portfolio_orchestrator_skip_buy_if_exit_critical BOOLEAN NOT NULL DEFAULT 1,
                    broker_sync_watchdog_enabled BOOLEAN NOT NULL DEFAULT 0,
                    broker_sync_watchdog_block_automation_on_unsafe BOOLEAN NOT NULL DEFAULT 1,
                    broker_sync_watchdog_stale_order_minutes INTEGER NOT NULL DEFAULT 10,
                    broker_sync_watchdog_stale_position_minutes INTEGER NOT NULL DEFAULT 10,
                    broker_sync_watchdog_allow_broker_reads BOOLEAN NOT NULL DEFAULT 1,
                    broker_sync_watchdog_allow_local_status_updates BOOLEAN NOT NULL DEFAULT 0,
                    broker_sync_watchdog_allow_order_submit BOOLEAN NOT NULL DEFAULT 0,
                    broker_sync_watchdog_allow_order_cancel BOOLEAN NOT NULL DEFAULT 0,
                    automation_soak_enabled BOOLEAN NOT NULL DEFAULT 0,
                    automation_soak_mode VARCHAR(40) NOT NULL DEFAULT 'dry_run_monitoring',
                    automation_soak_allow_live_phase1 BOOLEAN NOT NULL DEFAULT 0,
                    automation_soak_max_cycles_per_day INTEGER NOT NULL DEFAULT 3,
                    automation_soak_max_actions_per_day INTEGER NOT NULL DEFAULT 1,
                    automation_soak_require_broker_sync_healthy BOOLEAN NOT NULL DEFAULT 1,
                    automation_soak_require_production_ready BOOLEAN NOT NULL DEFAULT 1,
                    automation_soak_stop_on_any_critical BOOLEAN NOT NULL DEFAULT 1,
                    automation_soak_kill_latch_active BOOLEAN NOT NULL DEFAULT 0,
                    automation_soak_kill_latch_reason TEXT,
                    automation_soak_kill_latch_triggered_at DATETIME,
                    automation_soak_last_successful_cycle_at DATETIME,
                    automation_soak_consecutive_failure_count INTEGER NOT NULL DEFAULT 0,
                    automation_soak_max_consecutive_failures INTEGER NOT NULL DEFAULT 2,
                    automation_soak_max_daily_loss_pct FLOAT NOT NULL DEFAULT 0.02,
                    automation_soak_max_daily_loss_amount FLOAT,
                    automation_soak_max_unmatched_order_count INTEGER NOT NULL DEFAULT 0,
                    automation_soak_max_pending_sync_count INTEGER NOT NULL DEFAULT 0,
                    automation_soak_max_stale_order_count INTEGER NOT NULL DEFAULT 0,
                    automation_release_enabled BOOLEAN NOT NULL DEFAULT 0,
                    automation_release_mode VARCHAR(40) NOT NULL DEFAULT 'controlled_phase1',
                    automation_release_armed_at DATETIME,
                    automation_release_armed_by VARCHAR(80),
                    automation_release_disarmed_at DATETIME,
                    automation_release_reason TEXT,
                    automation_release_require_soak_pass BOOLEAN NOT NULL DEFAULT 1,
                    automation_release_require_watchdog_healthy BOOLEAN NOT NULL DEFAULT 1,
                    automation_release_require_production_ready BOOLEAN NOT NULL DEFAULT 1,
                    automation_release_require_kill_latch_clear BOOLEAN NOT NULL DEFAULT 1,
                    automation_release_max_actions_per_cycle INTEGER NOT NULL DEFAULT 1,
                    automation_release_max_daily_auto_actions INTEGER NOT NULL DEFAULT 2,
                    automation_release_max_daily_auto_buys INTEGER NOT NULL DEFAULT 1,
                    automation_release_max_daily_auto_sells INTEGER NOT NULL DEFAULT 1,
                    automation_release_allow_live_phase1 BOOLEAN NOT NULL DEFAULT 0,
                    automation_release_scheduler_enabled BOOLEAN NOT NULL DEFAULT 0,
...
def _create_quant_ab_observations_table_if_missing():
    ...
    _add_column_if_missing('quant_ab_observations', 'c_oversold_score', 'FLOAT')
    _add_column_if_missing('quant_ab_observations', 'c_macd_reversal_score', 'FLOAT')
    _add_column_if_missing('quant_ab_observations', 'c_price_stabilization_score', 'FLOAT')
    _add_column_if_missing('quant_ab_observations', 'c_intraday_reversal_score', 'FLOAT')
    _add_column_if_missing('quant_ab_observations', 'c_volume_confirmation_score', 'FLOAT')
    _add_column_if_missing('quant_ab_observations', 'c_downtrend_continuation_risk', 'FLOAT')
    _add_column_if_missing('quant_ab_observations', 'confidence_c', 'FLOAT')
    _add_column_if_missing('quant_ab_observations', 'data_quality_c', 'FLOAT')
    _add_column_if_missing('quant_ab_observations', 'reversal_state_c', 'VARCHAR(40)')
    _add_column_if_missing('quant_ab_observations', 'direction_c', 'VARCHAR(20)')
    _add_column_if_missing('quant_ab_observations', 'c_reason', 'TEXT')
    _add_column_if_missing('quant_ab_observations', 'c_notes_json', 'TEXT')
    _add_column_if_missing('quant_ab_observations', 'selected_by_c_shadow', 'BOOLEAN NOT NULL DEFAULT 0')
    with engine.begin() as conn:
...
def init_db():
    ...
    runtime_setting_columns = {
        ...
        "auto_buy_live_phase1_enabled": "BOOLEAN DEFAULT 0",
        "auto_buy_live_phase1_max_orders_per_day": "INTEGER DEFAULT 1",
        "auto_buy_live_phase1_max_notional_pct": "FLOAT DEFAULT 0.03",
        "auto_buy_live_phase1_max_notional_krw": "FLOAT DEFAULT 50000",
        "auto_buy_live_phase1_require_production_ready": "BOOLEAN DEFAULT 1",
        "auto_buy_live_phase1_allow_real_orders": "BOOLEAN DEFAULT 0",
        "auto_buy_live_phase1_provider": "VARCHAR(20) DEFAULT 'kis'",
        "auto_sell_live_phase1_enabled": "BOOLEAN DEFAULT 0",
        "auto_sell_live_phase1_max_orders_per_day": "INTEGER DEFAULT 1",
        "auto_sell_live_phase1_allow_real_orders": "BOOLEAN DEFAULT 0",
        "auto_sell_live_phase1_require_production_ready": "BOOLEAN DEFAULT 1",
        "auto_sell_live_phase1_provider": "VARCHAR(20) DEFAULT 'kis'",
        "auto_sell_live_phase1_allowed_candidate_types": "TEXT DEFAULT '[\"stop_loss\", \"take_profit\", \"trend_breakdown\", \"weak_momentum\"]'",
        ...
        "portfolio_orchestrator_max_actions_per_run": "INTEGER DEFAULT 1",
        "portfolio_orchestrator_require_production_ready": "BOOLEAN DEFAULT 1",
        "portfolio_orchestrator_skip_buy_if_sell_candidate": "BOOLEAN DEFAULT 1",
        "portfolio_orchestrator_skip_buy_if_sync_required": "BOOLEAN DEFAULT 1",
        "portfolio_orchestrator_skip_buy_if_exit_critical": "BOOLEAN DEFAULT 1",
        "broker_sync_watchdog_enabled": "BOOLEAN DEFAULT 0",
        "broker_sync_watchdog_block_automation_on_unsafe": "BOOLEAN DEFAULT 1",
        "broker_sync_watchdog_stale_order_minutes": "INTEGER DEFAULT 10",
        "broker_sync_watchdog_stale_position_minutes": "INTEGER DEFAULT 10",
        "broker_sync_watchdog_allow_broker_reads": "BOOLEAN DEFAULT 1",
        "broker_sync_watchdog_allow_local_status_updates": "BOOLEAN DEFAULT 0",
        "broker_sync_watchdog_allow_order_submit": "BOOLEAN DEFAULT 0",
        "broker_sync_watchdog_allow_order_cancel": "BOOLEAN DEFAULT 0",
        "automation_soak_enabled": "BOOLEAN DEFAULT 0",
        "automation_soak_mode": "VARCHAR(40) DEFAULT 'dry_run_monitoring'",
        "automation_soak_allow_live_phase1": "BOOLEAN DEFAULT 0",
        "automation_soak_max_cycles_per_day": "INTEGER DEFAULT 3",
        "automation_soak_max_actions_per_day": "INTEGER DEFAULT 1",
        "automation_soak_require_broker_sync_healthy": "BOOLEAN DEFAULT 1",
        "automation_soak_require_production_ready": "BOOLEAN DEFAULT 1",
        "automation_soak_stop_on_any_critical": "BOOLEAN DEFAULT 1",
        "automation_soak_kill_latch_active": "BOOLEAN DEFAULT 0",
        "automation_soak_kill_latch_reason": "TEXT",
        "automation_soak_kill_latch_triggered_at": "DATETIME",
        "automation_soak_last_successful_cycle_at": "DATETIME",
        "automation_soak_consecutive_failure_count": "INTEGER DEFAULT 0",
        "automation_soak_max_consecutive_failures": "INTEGER DEFAULT 2",
        "automation_soak_max_daily_loss_pct": "FLOAT DEFAULT 0.02",
        "automation_soak_max_daily_loss_amount": "FLOAT",
        "automation_soak_max_unmatched_order_count": "INTEGER DEFAULT 0",
        "automation_soak_max_pending_sync_count": "INTEGER DEFAULT 0",
        "automation_soak_max_stale_order_count": "INTEGER DEFAULT 0",
        "automation_release_enabled": "BOOLEAN DEFAULT 0",
        "automation_release_mode": "VARCHAR(40) DEFAULT 'controlled_phase1'",
        "automation_release_armed_at": "DATETIME",
        "automation_release_armed_by": "VARCHAR(80)",
        "automation_release_disarmed_at": "DATETIME",
        "automation_release_reason": "TEXT",
        "automation_release_require_soak_pass": "BOOLEAN DEFAULT 1",
        "automation_release_require_watchdog_healthy": "BOOLEAN DEFAULT 1",
        "automation_release_require_production_ready": "BOOLEAN DEFAULT 1",
        "automation_release_require_kill_latch_clear": "BOOLEAN DEFAULT 1",
        "automation_release_max_actions_per_cycle": "INTEGER DEFAULT 1",
        "automation_release_max_daily_auto_actions": "INTEGER DEFAULT 2",
        "automation_release_max_daily_auto_buys": "INTEGER DEFAULT 1",
        "automation_release_max_daily_auto_sells": "INTEGER DEFAULT 1",
        "automation_release_allow_live_phase1": "BOOLEAN DEFAULT 0",
        "automation_release_scheduler_enabled": "BOOLEAN DEFAULT 0",
