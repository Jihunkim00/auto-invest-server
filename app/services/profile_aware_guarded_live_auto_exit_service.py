...
class ProfileAwareGuardedLiveAutoExitService:
    ...
    def _run_response(self, **kwargs: Any) -> dict[str, Any]:
        ...
        return {
            ...
            "profile_key": kwargs.get("profile_key") or kwargs.get("active_profile"),
            "profile_name": kwargs.get("profile_name") or kwargs.get("active_profile"),
        ...
        *,
        ...
        if execution.get("submitted") is not True:
            ...
            response = self._run_response(
                ...
                gating_notes=[f"Shared KIS execution core blocked SELL: {block_reason}"],
                attempt_id=attempt.id,
                safety=safety,
            )
            attempt.status = status
