    ...
    def run(
        ...
        *,
        ...
        if lifecycle["can_scan_new_entry"] and remaining_slot_entry_budget > 0:
            ...
            entry_skip_reason = "entry_candidate_already_in_open_positions"

        return self._finish_parent(db, parent_log, lifecycle, child_results, entry_evaluated, entry_skip_reason)
