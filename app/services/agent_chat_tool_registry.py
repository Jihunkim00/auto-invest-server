...
_DEFAULT_TOOLS = [
    ...
    AgentChatToolDefinition(
        tool_name="automation_release_status_lookup",
        display_name="Automation Release Status",
        mode="read_only",
        risk_level="low",
        allowed_auto_execute=True,
        provider="kis",
        market="KR",
        description="Read-only PR100 automation release status lookup. It never arms, disarms, starts cycles, resets the latch, submits orders, or changes settings.",
    ),
    AgentChatToolDefinition(
